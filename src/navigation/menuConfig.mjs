const MENU_ITEMS = [
  ...
  { key: "grades", label: "Noten", to: "/noten", roles: ["trainee", "trainer", "admin"], group: "work" },
  ...
  { key: "admin-email-relay", label: "E-Mail-Relay", to: "/admin/email-relay", roles: ["admin"], group: "admin" },
